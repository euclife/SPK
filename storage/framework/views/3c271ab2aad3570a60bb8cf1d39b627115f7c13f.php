            ...
            <form class="form-horizontal" action="<?php echo e(url('profile')); ?>" method="POST" enctype="multipart/form-data">
              ...
              <fieldset class="content-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input type="file" class="form-control text-uppercase" name="surat_lamaran">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input type="number" class="form-control text-uppercase" name="ipk">
...
<?php echo $__env->make('layouts.dashboardMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Data\Project\Laravel\SPK\resources\views/pages/user/form/accept.blade.php ENDPATH**/ ?>