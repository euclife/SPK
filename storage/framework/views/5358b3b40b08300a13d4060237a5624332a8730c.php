           ...
           <ul class="nav navbar-nav no-border visible-xs-block">
			...
			<ul class="nav navbar-nav navbar-nav-material">
				<li class="<?php echo $__env->yieldContent('dashboardActive'); ?>"><a href="<?php echo e(url('dashboard')); ?>"><i class="icon-display4 position-left"></i> Dashboard</a></li>
                    <li class="<?php echo $__env->yieldContent('lowonganActive'); ?>"><a href="<?php echo e(url('lowongan')); ?>"><i class="icon-newspaper position-left"></i> Lowongan</a></li>
...
<?php /**PATH D:\Project\Laravel\SPK\resources\views/layouts/dashboardMaster.blade.php ENDPATH**/ ?>