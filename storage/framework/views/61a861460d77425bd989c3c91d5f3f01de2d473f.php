					...
					<tbody>
						<tr>
							...
							<td class="text-right col-md-2">
								<a href="<?php echo e(url('test')); ?>" class="btn bg-danger-300"><i class="icon-statistics position-left"></i> Test Online Sekarang</a>
							</td>
						</tr>
					</tbody>
				</table>
...
<?php echo $__env->make('layouts.dashboardMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Data\Project\Laravel\SPK\resources\views/pages/user/dashboard.blade.php ENDPATH**/ ?>