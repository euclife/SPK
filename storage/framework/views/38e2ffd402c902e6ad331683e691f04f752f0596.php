...
<!-- FONT AWESOME-->
   ...
   <!-- =============== PAGE VENDOR STYLES ===============-->
   <!-- WEATHER ICONS-->
   <link rel="stylesheet" href="<?php echo e(asset('template/admin/vendor/weather-icons/css/weather-icons.css')); ?>">
   <!-- =============== BOOTSTRAP STYLES ===============-->
   ...
   <!-- SCREENFULL-->
   <script src="v<?php echo e(asset('template/admin/vendor/screenfull/dist/screenfull.js')); ?>"></script>
   <!-- LOCALIZE-->
   <script src="<?php echo e(asset('template/admin/vendor/jquery-localize/dist/jquery.localize.js')); ?>"></script>
   <!-- =============== PAGE VENDOR SCRIPTS ===============-->
   <!-- SLIMSCROLL-->
   <script src="<?php echo e(asset('template/admin/vendor/jquery-slimscroll/jquery.slimscroll.js')); ?>"></script>
   <!-- SPARKLINE-->
   <script src="<?php echo e(asset('template/admin/vendor/jquery-sparkline/jquery.sparkline.js')); ?>"></script>
   <!-- MOMENT JS-->
   <script src="<?php echo e(asset('template/admin/vendor/moment/min/moment-with-locales.js')); ?>"></script>
   <!-- =============== APP SCRIPTS ===============-->
...
<!-- Main section-->
      ...
      <!-- Page footer-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\Laravel\SPK\resources\views/pages/user/index.blade.php ENDPATH**/ ?>