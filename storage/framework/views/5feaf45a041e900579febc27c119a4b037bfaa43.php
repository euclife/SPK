...
<script type="text/javascript" src="<?php echo e(asset('template/material/assets/js/pages/form_checkboxes_radios.js')); ?>"></script>
...
<form class="" action="<?php echo e(url('dashboard')); ?>" method="gett">
...
<?php echo $__env->make('layouts.dashboardMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Data\Project\Laravel\SPK\resources\views/pages/user/form/test.blade.php ENDPATH**/ ?>