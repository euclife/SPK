...
<head>
    ...
    <link href="{{asset('theme/css/zoomslider.css')}}" rel='stylesheet' type='text/css' />
...
<!--footer -->
    ...
    <script src="{{asset('theme/js/jquery.zoomslider.min.js')}}"></script>
    <!--//slider-->
    <!--search jQuery-->
    <script src="{{asset('theme/js/classie-search.js')}}"></script>
    <script src="{{asset('theme/js/demo1-search.js')}}"></script>
    <!--//search jQuery-->
    ...
    <script src="{{asset('theme/js/jquery.countup.js')}}"></script>
    <script>
        $('.counter').countUp();
    </script>
    <!-- //stats -->
