...
<div class="row">
    <div class="panel panel-flat">
        ...
        <form action="{{ url('admin/soal/create') }}" method="POST" class="form-horizontal"
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="number" class="form-control" name="score" min="0" value="{{ old('score') }}"
                            required>
                        @if ($errors->has('score'))
                        <div class="alert bg-danger-400 alert-styled-left">
                            <button type="button" class="close" data-dismiss="alert"><span>×</span><span
