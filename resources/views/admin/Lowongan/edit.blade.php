    ...
    <div class="col-md-12">
        <div class="panel panel-flat border-top-teal">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="{{url('admin/lowongan/edit',$lowongan->id_lowongan)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{method_field('PATCH')}}
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control text-uppercase" name="posisi" required placeholder="Masukkan Posisi Lowongan" value="{{$lowongan->posisi}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="tgl_lahir" placeholder="Masukkan Tanggal Selesai" name="tanggal_selesai" value="{{$lowongan->tanggal_selesai}}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="tgl_lahir" placeholder="Masukkan Keterangan Lowongan" name="keterangan" value="{{$lowongan->keterangan}}">
                          ...
                          <table class="table">
                            ...
                            <tbody>
                              @foreach ($syarat as $key => $value)
                                ...
                                <tr>
                                  <td><input type="text" class="form-control text-uppercase" name="syarat[]" placeholder="Masukkan Syarat Lowongan" required value="{{$value->nama_syarat}}"></td>
                                ...
                                @else
                                  <tr id="row{{$key}}">
                                    <td><input type="text" class="form-control text-uppercase" name="syarat[]" placeholder="Masukkan Syarat Lowongan"  value="{{$value->nama_syarat}}"required></td>
                                    <td><button type="button" class="text-right btn btn-danger btn-icon btn-rounded btn_remove legitRipple" id="{{$key}}" name="remove">
