                    ...
                    <div class="login px-4 mx-auto mw-100">
                        ...
                        <form  class="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" aria-describedby="emailHelp" name="email" value="{{ old('email') }}" required autocomplete="email">
                            ...
                            <button type="button" id="login" class="btn btn-primary submit mb-4">{{ __('Masuk') }}</button>
